...
Equipo Técnico
para el desarrollo del MAPAUBA
...
***NO RESPONDA ESTE CORREO ELECTRONICO****
		...
		$query = "INSERT INTO
			...
			echo '<h2>¡Gracias!</h2> Su usuario ha sido registrado con éxito. Ahora puede <a href="login.php">ingresar aqui</a>"';
...
<html>
<head>
	<title>MAPAUBA - Registro de Usuarios</title>
	...
	?>
		...
		<form action="registro.php" method="post">
			...
			<div class="aclaracionsubmit">
				Toda la información registrada será utilizada exclusivamente en el marco del proyefcto MAPAUBA
			</div>			
