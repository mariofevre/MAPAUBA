...
$c = mysql_query("SHOW FULL COLUMNS FROM `MAPAUBA`.`actividades`");
...
?>
	...
	<title>MAPAUBA - Cofiguración de actividades</title>
...
<body>
	...
	<div id="pageborde"><div id="page">
		...
		<iframe id='mapa' name='mapa' src='./MAPAactividad.php?actividad=<?php echo $Actividad;?>&consulta=creararea'></iframe>
